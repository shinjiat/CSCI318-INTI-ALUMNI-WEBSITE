...
<head>
    ...
    <!-- lined-icons -->
    <link rel="stylesheet" href="../memberarea/css/icon-font.min.css" type='text/css' />
    <!-- //lined-icons -->
...
$sql = mysqli_query($dbconfig, "Select * from _user WHERE username like '%$query%'");
                  ...
                  <!---->
                    ...
                    <form enctype="multipart/form-data">
                      ...
                      <div class="col-md-6 form-group1">
                        ...
                        <input id="Efname" name ="fname" type="text" placeholder="Firstname"  value='.$fname.'>
                      </div>
                      <div class="col-md-6 form-group1 form-last">
                        <label class="control-label">Lastname</label>
                        <input id="Elname" name ="lname" type="text" placeholder="Lastname"  value='.$lname.'>
                      </div>
                      ...
                      <div class="col-md-12 form-group1 group-mail">
                        ...
                        <input id="Eemail" name="email" type="text" placeholder="Email"  value="'.$email.'">
                      </div>
                       <div class="clearfix"> </div>
                      <div class="col-md-12 form-group1 group-mail">
                        <label class="control-label">Current Position</label>
                        <input id="Eposition" name="position" type="text" placeholder="Current Position"  value ="'.$position.'">
                      </div>
                       <div class="clearfix"> </div>
                        <div class="col-md-12 form-group2 group-mail">
                        <label class="control-label">Language</label>
                      <select id="ElanguageOne" name="language1">
                     ...
                     <select id="ElanguageTwo" name="language2">
                    ...
                    <select id="ElanguageThree" name="language3">
                    <option value="'.$language3.'">'.$language3.'</option>
                     ...
                     <div class="clearfix"> </div>
                      <div class="col-md-12 form-group1 ">
                        ...
                        <textarea id="Ebiography" name ="biography" placeholder="Your Comment..." >'.$biography.'</textarea>
                      </div>
                       <div class="clearfix"> </div>
                      <div class="vali-form">
                      <div class="col-md-6 form-group1">
                        <label class="control-label">Phone Number</label>
                        <input id="Ephone" name="phone" type="text" placeholder="Phone Number" value='.$phone.'>
                      </div>
...
echo'                
                      ...
                      <div class="col-md-12 form-group1 group-mail">
                        ...
                        <input id="Edate" name="dob" type="date" class="form-control1 ng-invalid ng-invalid-required" ng-model="model.date" >
                      </div>
                       <div class="clearfix"> </div>
                       <div class="clearfix"> </div>
                        <div class="col-md-12 form-group2 group-mail">
                        <label class="control-label">Country</label>
                      <select id="Ecountry" name="country">
                      <option value="'.$country.'">'.$country.'</option>
                       ...
                       <div class="col-md-12 form-group1 ">
                        ...
                        <textarea id="Eoffice" name="office" placeholder="" value='.$office.'>'.$office.'</textarea>
                      </div>
                      <br><br>
                      <label class="custom-file" style="width:100%;">
                        <label class="control-label">Upload Profile Picture : </label>
                        <input id="Efile" type="file" name="file" class="custom-file-input" value="" >
                        <img hidden src="logo.jpg" id="davidImg"/>
                      ...
                      <div class="col-md-12 form-group button-2">
                        <button data-id="'.$id.'" id="#fuckDavid" type="button" name="submit_profile" class="btn btn-success david">Submit</button>
                      </div>
